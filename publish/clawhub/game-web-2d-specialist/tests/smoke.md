...
Bundle: `game-web-2d-specialist`
Version: `1.1.0`

## Prompt

Use `game-web-2d-specialist` on a fitting game-development task.
...
- Companion skills referenced in this bundle: game-douyin-h5, using-game-superpowers

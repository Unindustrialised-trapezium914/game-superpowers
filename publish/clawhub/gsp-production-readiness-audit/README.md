...
- Use `gsp-production-readiness-audit` for this game project and keep the output evidence-based.
- Apply `gsp-production-readiness-audit` to improve or assess an existing browser game in a focused way.
- Use `gsp-production-readiness-audit` as part of a larger Game Superpowers workflow when the request clearly matches game production readiness audit.
...
```text
skills/gsp-production-readiness-audit/SKILL.md
```

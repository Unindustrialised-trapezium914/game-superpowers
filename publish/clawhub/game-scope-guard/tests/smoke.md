...
Bundle: `game-scope-guard`
Version: `1.1.0`

## Prompt

Use `game-scope-guard` on a fitting game-development task.
...
- Companion skills referenced in this bundle: game-scope-profile, using-game-superpowers

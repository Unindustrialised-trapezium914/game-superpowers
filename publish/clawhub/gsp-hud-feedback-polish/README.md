...
- Use `gsp-hud-feedback-polish` for this game project and keep the output evidence-based.
- Apply `gsp-hud-feedback-polish` to improve or assess an existing browser game in a focused way.
- Use `gsp-hud-feedback-polish` as part of a larger Game Superpowers workflow when the request clearly matches game hud feedback polish.
...
```text
skills/gsp-hud-feedback-polish/SKILL.md
```

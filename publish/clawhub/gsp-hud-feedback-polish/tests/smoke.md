...
Bundle: `gsp-hud-feedback-polish`
Version: `1.1.0`

## Prompt

Use `gsp-hud-feedback-polish` on a fitting game-development task.
...
- Companion skills referenced in this bundle: gsp-feedback-design

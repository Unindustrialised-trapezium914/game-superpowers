...
Bundle: `gsp-architecture-maintainability-audit`
Version: `1.1.0`

## Prompt

Use `gsp-architecture-maintainability-audit` on a fitting game-development task.
...
- Companion skills referenced in this bundle: gsp-orchestrator

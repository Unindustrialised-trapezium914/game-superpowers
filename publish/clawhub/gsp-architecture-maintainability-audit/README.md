...
- Use `gsp-architecture-maintainability-audit` for this game project and keep the output evidence-based.
- Apply `gsp-architecture-maintainability-audit` to improve or assess an existing browser game in a focused way.
- Use `gsp-architecture-maintainability-audit` as part of a larger Game Superpowers workflow when the request clearly matches game architecture maintainability audit.
...
```text
skills/gsp-architecture-maintainability-audit/SKILL.md
```

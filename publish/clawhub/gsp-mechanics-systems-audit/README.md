...
- Use `gsp-mechanics-systems-audit` for this game project and keep the output evidence-based.
- Apply `gsp-mechanics-systems-audit` to improve or assess an existing browser game in a focused way.
- Use `gsp-mechanics-systems-audit` as part of a larger Game Superpowers workflow when the request clearly matches game mechanics systems audit.
...
```text
skills/gsp-mechanics-systems-audit/SKILL.md
```

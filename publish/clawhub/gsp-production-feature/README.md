...
- Use `gsp-production-feature` for this game project and keep the output evidence-based.
- Apply `gsp-production-feature` to improve or assess an existing browser game in a focused way.
- Use `gsp-production-feature` as part of a larger Game Superpowers workflow when the request clearly matches game production feature.
...
```text
skills/gsp-production-feature/SKILL.md
```

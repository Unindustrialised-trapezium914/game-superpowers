...
Bundle: `gsp-scope-guard`
Version: `1.1.0`

## Prompt

Use `gsp-scope-guard` on a fitting game-development task.
...
- Companion skills referenced in this bundle: gsp-scope-profile, gsp-orchestrator

...
- Use `gsp-web-3d-specialist` for this game project and keep the output evidence-based.
- Apply `gsp-web-3d-specialist` to improve or assess an existing browser game in a focused way.
- Use `gsp-web-3d-specialist` as part of a larger Game Superpowers workflow when the request clearly matches game web 3d specialist.
...
```text
skills/gsp-web-3d-specialist/SKILL.md
```

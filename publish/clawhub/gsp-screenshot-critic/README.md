...
- Use `gsp-screenshot-critic` for this game project and keep the output evidence-based.
- Apply `gsp-screenshot-critic` to improve or assess an existing browser game in a focused way.
- Use `gsp-screenshot-critic` as part of a larger Game Superpowers workflow when the request clearly matches game screenshot critic.
...
```text
skills/gsp-screenshot-critic/SKILL.md
```

...
- Use `gsp-ux-flow-audit` for this game project and keep the output evidence-based.
- Apply `gsp-ux-flow-audit` to improve or assess an existing browser game in a focused way.
- Use `gsp-ux-flow-audit` as part of a larger Game Superpowers workflow when the request clearly matches game ux flow audit.
...
```text
skills/gsp-ux-flow-audit/SKILL.md
```

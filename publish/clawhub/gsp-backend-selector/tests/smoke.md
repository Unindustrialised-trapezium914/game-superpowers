...
Bundle: `gsp-backend-selector`
Version: `1.1.0`

## Prompt

Use `gsp-backend-selector` on a fitting game-development task.
...
- Companion skills referenced in this bundle: gsp-web-2d-specialist, gsp-web-3d-specialist, gsp-orchestrator

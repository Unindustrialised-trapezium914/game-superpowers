...
- Use `game-production-code` for this game project and keep the output evidence-based.
- Apply `game-production-code` to improve or assess an existing browser game in a focused way.
- Use `game-production-code` as part of a larger Game Superpowers workflow when the request clearly matches game production code.
...
```text
skills/game-production-code/SKILL.md
```
